...
public class SecurityConfig {
     ...
     * "Authentication Configuration y la expone como un bean disponible en el contexto
     * de la aplicación.
     *
     ...
     *                      Este objeto incluye los detalles del flujo de autenticación configurado, como
