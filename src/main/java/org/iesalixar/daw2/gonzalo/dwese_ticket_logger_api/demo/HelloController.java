package org.iesalixar.daw2.gonzalo.dwese_ticket_logger_api.demo;
...
@RestController
public class HelloController {  // Creación del logger para esta clase, nos permitirá registrar mensajes en diferentes niveles (INFO, DEBUG, ERROR, etc.)
